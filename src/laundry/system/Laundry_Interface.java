...
public class Laundry_Interface extends javax.swing.JFrame {
    ...
    private void doneButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doneButtonActionPerformed
        try {
            ...
            int service = fetchService();
            int payment_status = fetchPaymentStat();
    ...
    private void editQButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editQButtonActionPerformed
        ...
        if (selectedRow != -1) { 
            ...
            laundryPanel.repaint();
            laundryPanel.revalidate();
            String name = laundryTable.getValueAt(selectedRow, 0).toString();
            String contact = laundryTable.getValueAt(selectedRow, 1).toString();
            String weight = laundryTable.getValueAt(selectedRow, 2).toString();
            String price = laundryTable.getValueAt(selectedRow, 3).toString();
            String date = laundryTable.getValueAt(selectedRow, 6).toString();
            qOwnerName.setText(name);
            qOwnerContact.setText(contact);
            qWeight.setText(weight);
            qPrice.setText(price);
            qRecievedTime.setText(date);
            qPaymentStatus.setSelectedItem(laundryTable.getValueAt(selectedRow, 5)); // combo box
            qLaundryStatus.setSelectedItem(laundryTable.getValueAt(selectedRow, 7));
        } else { 
