...
public class Laundry_Interface extends javax.swing.JFrame {
    ...
    private void laundryBActionPerformed(java.awt.event.ActionEvent evt) {                                         
        loadLaundryData();
    ...
    private void customerBActionPerformed(java.awt.event.ActionEvent evt) {                                          
 
    }                                         

    private void settingsBActionPerformed(java.awt.event.ActionEvent evt) {                                          
        contentPanel.removeAll();
        contentPanel.repaint();
        contentPanel.revalidate();
    ...
    private void customerB1ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        loadCustomerData();
        contentPanel.removeAll();
        contentPanel.repaint();
        contentPanel.revalidate();
    ...
    private void l_nameActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
    }                                      

    private void c_numberActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
    }                                        
    ...
    private void f_nameAddActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void l_nameAddActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void c_numberAddActionPerformed(java.awt.event.ActionEvent evt) {                                            
        // TODO add your handling code here:
    }                                           

    private void addConfirmBtnActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    private void f_nameEditActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    }                                          

    private void l_nameEditActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    }                                          

    private void c_numberEditActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            
    ...
    private void editConfirmBtnActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void f_nameDeleteActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void l_nameDeleteActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void c_numberDeleteActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void deleteCancelBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                
        contentPanel.removeAll();
        contentPanel.repaint();
        contentPanel.revalidate();
        contentPanel.add(customerTablePanel);
    ...
    private void deleteConfirmBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void editCustomerBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                
        contentPanel.removeAll();
        contentPanel.repaint();
        contentPanel.revalidate();
    ...
    private void deleteCustomerBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        contentPanel.removeAll();
        contentPanel.repaint();
        contentPanel.revalidate();
    ...
    private void addCustomerBtnMouseClicked(java.awt.event.MouseEvent evt) {                                            
        // TODO add your handling code here:
    }                                           
    ...
    private void f_nameMouseClicked(java.awt.event.MouseEvent evt) {                                    
        clearSelectedCustomer();
    }                                   

    private void f_nameKeyReleased(java.awt.event.KeyEvent evt) {                                   
        String query = f_name.getText().trim();
        applyFilter(query);
    }                                  

    private void l_nameMouseClicked(java.awt.event.MouseEvent evt) {                                    
        clearSelectedCustomer();
    }                                   

    private void c_numberMouseClicked(java.awt.event.MouseEvent evt) {                                      
        clearSelectedCustomer();
    }                                     

    private void l_nameKeyReleased(java.awt.event.KeyEvent evt) {                                   
        String query = l_name.getText().trim();
        applyFilter(query);
    }                                  

    private void c_numberKeyReleased(java.awt.event.KeyEvent evt) {                                     
        String query = c_number.getText().trim();
        applyFilter(query);
    }                                    

    private void serviceTypeActionPerformed(java.awt.event.ActionEvent evt) {                                            
    ...
    private void addQButtonActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    private void browseCustomersActionPerformed(java.awt.event.ActionEvent evt) {                                                
        loadCustomerData();
    ...
    private void browseCustomerTableMouseClicked(java.awt.event.MouseEvent evt) {                                                 

    }                                                

    private void ownerNameActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         
    ...
    private void dateNtimeActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void UserAccountActionPerformed(java.awt.event.ActionEvent evt) {                                            
        // TODO add your handling code here:
    }                                           

    private void PaymentOptionsActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void SystemPreferencesActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        // TODO add your handling code here:
    }                                                 

    private void UserAccountMouseClicked(java.awt.event.MouseEvent evt) {                                         
    ...
    private void SystemPreferencesMouseClicked(java.awt.event.MouseEvent evt) {                                               
        SystemPreferencesDialog.showSystemPreferencesDialog(this);
    }                                              

    private void PaymentOptionsMouseClicked(java.awt.event.MouseEvent evt) {                                            
        // TODO add your handling code here:
    }                                           
